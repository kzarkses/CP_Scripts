...
FXManager.init(r, Core, Persistence)
GestureSystem.init(r, Core, FXManager)
PresetSystem.init(r, Core, FXManager, GestureSystem, Persistence)
UI.init(r, Core, FXManager, GestureSystem, PresetSystem, Persistence, style_loader, ctx, header_font_size, item_spacing_x, item_spacing_y, window_padding_x, window_padding_y)
