-- @description MediaPropertiesToolbar - OFF
-- @version 1.0
...
function FindScriptByName(script_name)
    ...
    local possible_paths = {
        resource_path .. "/Scripts/CP_Scripts/Media Properties Toolbar/" .. script_name,
...
function StopMediaPropertiesToolbar()
    local script_name = "CP_MediaPropertiesToolbar.lua"
