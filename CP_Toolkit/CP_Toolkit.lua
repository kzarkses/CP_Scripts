...
UI.SetFontBold    = Core.SetFontBold      -- Body weight, same size: emphasis
UI.SetFontMonoBold = Core.SetFontMonoBold
...
-- ModKnob (knob + modulation overlay)
function UI.ModKnob(id, label, base, depth, live, opts)
